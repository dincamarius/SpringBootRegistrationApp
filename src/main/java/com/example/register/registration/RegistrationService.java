...
import com.example.register.appuser.AppUser;
import com.example.register.appuser.AppUserRole;
import com.example.register.appuser.AppUserService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = userService.singUpUserAndReturnToken(new AppUser(
    ...
    public String confirmToken(String token){
        ...
        LocalDateTime confirmedAt = LocalDateTime.now();
         if(confirmationToken.getExpiresAt().isBefore(confirmedAt)) {
